...
const ContactUsForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // In no-cors mode, the response is opaque, meaning we cannot read its body.
      // However, if the fetch promise resolves without throwing, the submission has succeeded.
